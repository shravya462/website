...
if(isset($_POST['submit'])){
   $to = "aishspark10@gmail.com"; // this is your Email address
...
<head>
    ...
    <!-- Dark -->
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/fire-bush.html" title="fire-bush" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/pastel-green.html" title="pastel-green" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/electric-violet.html" title="electric-violet" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/blue.html" title="blue" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/razzmatazz.html" title="razzmatazz" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/caribbean-green.html" title="caribbean-green" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/cornflower-blue.html" title="cornflower-blue" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/purple.html" title="purple" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/azure-radiance.html" title="azure-radiance" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/flush-orange.html" title="flush-orange" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/apple.html" title="apple" media="all">
    <link rel="alternate stylesheet" type="text/css" href="switcher/css/dark/red.html" title="red" media="all">

</head>

<body class="sidebar-demo close-sidebar">
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="fxt-offcanvas-wrap">             
            <div class="fxt-offcanvas-content">               
                <div class="logo-area">
                    <a href="index2.html" class="default-logo"><img src="media/logo-sidebar.png" alt="Logo"></a>
                </div>
                <button id="btn-toggle" class="btn-toggle sidebar-toggle sidebar-toggle-btn">
                    <span></span>
                    <span></span>
                    <span></span>
                    <span></span>
            ...
            <div class="fxt-offcanvas-nav">
                <ul id="onepage_nav">
                    ...
                    <li><a href="#section2">Lifejourney</a></li>
                    <li><a href="#section3">Resources</a></li>
                    <li><a href="#section4">Witnesses</a></li>
                    <li><a href="#section5">Links</a></li>
                    <li><a href="#section6">News</a></li>
                    <li><a href="#section7">AV Gallery</a></li>
        ...
        <!--=            Banner Start           =-->
        <!--=====================================-->
        <section class="fxt-main-banner-section bg-common" data-bg-image="media/bg1.jpg">
            <div class="container">
                <div class="fxt-main-banner-box-layout1 has-animation">
                    <div class="top-content">
                        ...
                        <div class="item-content">
                            ...
                            <div class="translate-bottom-100 opacity-animation transition-150 transition-delay-1100">
                                <div class="cd-intro">
                                    <h2 class="small-text cd-headline clip">
                                        <span class="item-subtitle">Servant of God </span>
                                        <span class="cd-words-wrapper">
                                            <b class="item-subtitle is-visible" >Rev. Fr. Alfred Roche Capuchin</b>
                                            <b >Rev. Fr. Alfred Roche Capuchin</b>
                                            <b >Rev. Fr. Alfred Roche Capuchin</b>
                                            <b >Rev. Fr. Alfred Roche Capuchin</b>
                                        </span>
                                    </h2>
        ...
        <!--=            Testimonial Start      =-->
        <!--=====================================-->
        <section class="fxt-testimonial-section parallaxie" data-bg-image="media/figure/figure2.jpg">
            <div class="container">
        ...
        <!--=             Portfolio Start         =-->
        <!--=====================================-->
        <section class="fxt-portfolio-section bg-color-1" id="section5">
            <div class="container">
                <div class="fxt-heading-layout1">
                    <h2 class="heading-title">Recent Portfolio</h2>
                    <div class="heading-paragraph">There are many variations of passages of Lorem Ipsum available</div>
                    <div class="heading-line"></div>
                </div>
                <div class="isotope-wrap">
                    ...
                    <div class="row featuredContainer">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-100">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio1.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio1.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 web has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-400">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio2.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio2.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 photography has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-700">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio3.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio3.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 photography has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-1000">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio4.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio4.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 web photography has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-1300">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio5.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio5.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 mockups has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-1600">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio6.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio6.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 photography has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-1900">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio7.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio7.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 photography has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-2200">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio8.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio8.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12 photography has-animation">
                            <div class="translate-left-10 opacity-animation transition-200 transition-delay-2500">
                                <div class="fxt-portfolio-box-layout1">
                                    <div class="item-img">
                                        <img src="media/portfolio/portfolio9.jpg" alt="Portfolio">
                                        <div class="item-content">
                                            <div class="item-icon"><a href="media/portfolio/portfolio9.jpg" class="popup-zoom"
                                                    data-fancybox-group="gallery"><i class="fas fa-images"></i></a></div>
                                            <h3 class="item-title"><a href="single-project.html">BRANDING DESIGN</a></h3>
                                            <div class="item-paragraph">Work description here</div>
                                        </div>
        ...
        <!--=            Progress Start         =-->
        <!--=====================================-->
        <section class="fxt-progress-section bg-common bg-attachment-fixed" data-bg-image="media/figure/figure1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="fxt-progress-box-layout1">
                            <h2 class="counting-text counter">2,500</h2>
                            <div class="item-label">Project Works</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="fxt-progress-box-layout1">
                            <h2 class="counting-text counter">1,764</h2>
                            <div class="item-label">Completed Project</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="fxt-progress-box-layout1">
                            <h2 class="counting-text counter">548</h2>
                            <div class="item-label">Happy Clients</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="fxt-progress-box-layout1">
                            <h2 class="counting-text counter">739</h2>
                            <div class="item-label">Award Wins</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="fxt-contact-box-layout1">
                            ...
                            <div class="contact-list">
                                <div class="item-icon">
                                    <i class="flaticon-tele#ad1f41"></i>
                                </div>
                                <div class="item-content">
                                    <h3 class="item-title">#ad1f41</h3>
                        ...
                        <div class="fxt-contact-box-layout2">
                            <form method="POST" id="contact-form">
                                <div class="row">
									...
									<div class="col-lg-6 form-group">
                                        <input type="text" class="form-control" placeholder="#ad1f41" name="#ad1f41" data-error="#ad1f41 field is required" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="col-lg-6 form-group">
